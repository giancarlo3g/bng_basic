...
5. 2 subscribers with same VLAN, 4 hosts
...
6. 2 subs with different VLAN, 4 hosts
...
-- ONT_654321
   (BNG_HSI_Sub_Profile)
   |
   +-- sap:[lag-100:2000.2021] - sla:UpTo1Gbps
       |
       +-- IPOE-session - mac:02:42:ac:11:02:01 - svc:3000
           |
           +-- 172.16.10.11 - DHCP
...
Queue : Sub=ONT_654321:UpTo1Gbps 3000->lag-100:2000.2021(1/1/c3/1)->1
```
